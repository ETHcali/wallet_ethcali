          ...
          >
            <div className="min-w-0 flex-1">
              <div className="flex min-w-0 items-center gap-2">
                <span className="truncate font-mono text-sm text-content-primary">
            ...
            <div className="shrink-0 text-right">
              <div className="font-mono text-sm font-semibold text-eth-blue-text">
              ...
              {entry.txHash && explorer && (
                <a
                  ...
                  className="text-[11px] text-content-faint hover:text-eth-blue-text"
                >
                  tx ↗
                </a>
              )}
