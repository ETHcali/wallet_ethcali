...
Ethereum Sepolia
Base Mainnet
If you need a specific chain, please reach out to us.
...
Verifier Contract
ZKPassport maintains a deployed ZKPassportVerifier contract at this address 0x1D000001000EFD9a6371f4d90bB8920D5431c0D8 that handles the verification of the proofs on all the chains listed above. Your contracts will interact with this verifier. Since the verifier address is deterministic, it is the same for all networks.
